...
const HeroOverlay: React.FC = () => {
  return (
    <div className="relative z-10 max-w-5xl mx-auto px-6 pt-40 pb-32 mt-10 text-center">

      {/* Badge */}
      <div className="mx-auto m-10 inline-flex items-center justify-center gap-2 rounded-full bg-[#FFFFFF]/40 px-6 py-2 text-[10px] font-bold uppercase border-white/60 border lg:backdrop-blur-[12px] text-center tracking-[4px] lg:w-[347px]">
  <span className="w-2 h-2 rounded-full bg-[#D4AF37] shrink-0" />
  <span className="text-center !text-[#0F172A]/80">
