...
const CTA: React.FC = () => {
  return (
    <section className="relative py-28 px-20 z-10">
      <div className="md:max-w-5xl mx-auto bg-[#E5F7F9] rounded-[40px] py-20 px-12 text-center border-neon-cta">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          <button className="fish px-10 py-5 rounded-full text-[11px] font-black tracking-widest uppercase hover:bg-slate-300 transition-all">
            Partner With Us
          </button>
