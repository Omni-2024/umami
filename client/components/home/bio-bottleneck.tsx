...
const BiologicalBottleneckSection: React.FC = () => {
  ...
  return (
    <section className="relative py-4 md:py-18 px-6 md:px-20 bg-white z-20">
      <div className="md:max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        {/* RIGHT CONTENT */}
        <div className="order-2 md:order-none flex flex-col gap-4 md:gap-8 text-left">

          <h2 className="text-[30px] md:text-[44px] lg:leading-[54px]">
            Understanding the{" "}
          ...
          <p className="text-[13px] md:text-[16px] !text-[#033E8A] font-medium lg:leading-[24.2px] text-justify">
          ...
          {/* ACCORDION */}
          <div className="mt-2 flex flex-col gap-4 md:gap-4">
          ...
          {/* CTA BUTTON */}
          <button className="h-[66px] mt-4 fish px-8 py-4 rounded-full text-[13px] font-bold tracking-wide hover:bg-[#1a2e4d] transition-colors">
